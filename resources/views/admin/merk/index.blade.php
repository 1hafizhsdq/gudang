...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-primary mt-4 mb-4" id="add"><i class="bi bi-plus"></i> Tambah Merk</button>
...
<script>
    ...
    $(document).ready(function() {
        $('#add').click(function(){
            $('#form-merk').find('input').val('');
            $('#modal-merk').modal('show');
            $('.modal-title').html('Form Tambah merk');
            $('#sv').html('Simpan');
        });
    ...
    function editData(id) {
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                form.find('#merk').val(result.merk)
                $('#modal-merk').modal('show');
                $('.modal-title').html('Form Edit Merk');
                $('#sv').html('Update');
            }
        });
    }
